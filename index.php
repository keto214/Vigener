...
<html>
	<head>
		<title>7 Guys - Mã hoá Vigener</title>
	...
	<body>
		...
		<form action="index.php" method="post">
			<table cellpadding="5" align="center" cellpadding="2" border="7">
				<caption><hr><b>Mã hoá Vigener</b><hr></caption>
				<tr>
					<td align="center">Vui lòng nhập password mã hoá kí tự: <input type="text" placeholder="MK chữ cái in hoa" name="pswd" id="pass" value="<?php echo htmlspecialchars($pswd); ?>" /></td>
				</tr>
				<tr>
					<td align="center"><textarea id="box" name="code"><?php echo htmlspecialchars($code); ?></textarea></td>
				</tr>
				<tr>
					<td><input type="submit" name="encrypt" class="button" value="Mã hoá" onclick="validate(1)" /></td>
				</tr>
				<tr>
					<td><input type="submit" name="decrypt" class="button" value="Giải mã" onclick="validate(2)" /></td>
				</tr>
				<tr>
					<td align="center"> Design by 7 Guys | <span style="cursor:pointer;color:#000" onclick="help()"></span></td>
				</tr>
				<tr>
